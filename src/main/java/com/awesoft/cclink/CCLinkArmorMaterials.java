...
public enum CCLinkArmorMaterials implements ArmorMaterial {
    ...
    private final Supplier<Ingredient> repairIntgredient;

    public static final int[] BASE_DURABILITY = {11,16, 16, 13};

    CCLinkArmorMaterials(String name, int durabilityMultiplier, int[] protectionAmounts, int enchantmentValue, SoundEvent equipSound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIntgredient) {
        this.name = name;
        ...
        this.repairIntgredient = repairIntgredient;
    }
    ...
    public Ingredient getRepairIngredient() {
        return this.repairIntgredient.get();
    }

    @Override
    public String getName() {
        return CCLink.MODID+":"+this.name;
    }
