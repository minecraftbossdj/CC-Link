...
public class ItemInvIntegratedLinkProvider implements ICapabilityProvider, INBTSerializable<CompoundTag> {
    ...
    public ItemInvIntegratedLinkProvider(ItemStack stack, int size) {
        this.stack = stack;
