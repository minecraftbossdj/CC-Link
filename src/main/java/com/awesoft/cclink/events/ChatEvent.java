    ...
    public static void onPlayerChat(ServerChatEvent event) {
        ...
        if (player.getInventory().hasAnyOf(items)) {
            for (int i = 0; i < player.getInventory().getContainerSize(); i++) {
                if (player.getInventory().getItem(i).getItem() == ItemRegistry.LINK_CORE.get().asItem() || player.getInventory().getItem(i).getItem() == ItemRegistry.LINK_CORE_COMMAND.get().asItem() || player.getInventory().getItem(i).getItem() == ItemRegistry.INTEGRATED_LINK_CORE.get().asItem()) {
