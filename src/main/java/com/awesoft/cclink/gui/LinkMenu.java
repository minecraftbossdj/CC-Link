...
public class LinkMenu extends AbstractComputerMenu {
    ...
    public LinkMenu(
        ...
        super(CCMenus.LINK_MENU.get(), id, canUse, family, computer, menuData);
        this.data = data;
        addDataSlots(data);
    ...
    public static LinkMenu ofMenuData(int id, Inventory player, ComputerContainerData data) {
        return new LinkMenu(
                id, x -> true, data.family(), null, data,
                player, new SimpleContainer(5), new SimpleContainerData(1)
        );
    }
