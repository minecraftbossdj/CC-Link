...
public class IntegratedLinkScreen extends AbstractComputerScreen<IntegratedLinkMenu> {
    private static final ResourceLocation BACKGROUND_ADVANCED = new ResourceLocation("cclink", "textures/gui/link_integrated.png");
    ...
    public IntegratedLinkScreen(IntegratedLinkMenu menu, Inventory playerInv, Component title) {
