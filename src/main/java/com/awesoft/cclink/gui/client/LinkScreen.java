package com.awesoft.cclink.gui.client;
...
public class LinkScreen extends AbstractComputerScreen<LinkMenu> {
    private static final ResourceLocation BACKGROUND_ADVANCED = new ResourceLocation("cclink", "textures/gui/link_advanced.png");
    ...
    public LinkScreen(LinkMenu menu, Inventory playerInv, Component title) {
